		...
		<>
			<div className='bg-black d-flex justify-content-center align-items-center' style={{ height: '100vh', width: '100%' }}>
				<div className='bg-light p-5 rounded-2' style={{ width: '500px' }}>
					...
					<div className='my-3'>
						<TextField id="outlined-basic" className='w-100' value={Principle} label="₹ Principle amount" name='principle' variant="outlined" onChange={(e)=>validate(e)} />
					...
					<div className="mb-3">
						<TextField id="outlined-basic" className='w-100' label="Year" value={year} variant="outlined" name='year' onChange={(e)=>validate(e)} />
